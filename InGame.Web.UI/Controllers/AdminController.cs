...
using InGame.Web.UI.Auth;
using InGame.Web.UI.Models.AdminViewModels;
...
namespace InGame.Web.UI.Controllers
{
    ...
    public class AdminController : Controller
    {
        ...
        public async Task<IActionResult> ManageClaimsForUser(string userId)
        {
            ...
            var claimsManagementViewModel = new ClaimsManagementViewModel { UserId = user.Id, AllClaimsList = InGameClaimTypes.ClaimsList };
